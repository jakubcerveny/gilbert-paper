...
without concern for optimization of defect reduction.
...
\begin{minipage}[ht]{0.49\linewidth}
	...
	\begin{minipage}{0.49\textwidth}
		\centering
		\includegraphics[width=\linewidth]{gilbert3d_eccentric_alpha_example.pdf}
		\label{fig:gilbert3d_eccentric_alpha_example_xxx}
		\captionof{figure}{ }
	\end{minipage}
	...
	\begin{minipage}{0.49\textwidth}
		\centering
		\includegraphics[width=\linewidth]{gilbert3d_eccentric_alpha_example.pdf}
		\label{fig:gilbert3d_eccentric_alpha_example_yyy}
		\captionof{figure}{ }
	\end{minipage}
...
Generalizing a Hilbert space filling curve to arbitrary side lengths is not a well posed problem
