...
\author{ Jakub \v{C}erven\'{y}\textsuperscript{1} and Zzyv Zzyzek\textsuperscript{2}
\vspace{5pt}\\
\textsuperscript{1}Prague, Czechia; jakub.cerveny@gmail.com\\
\textsuperscript{2}Ithaca, New York, USA; zzyzek@thumpernet.com}
...
\begin{thebibliography}{99}
  ...
  \bibitem{anders2009} S. Anders. ``Visualization of genomic data with the Hilbert curve.'' \textit{Bioinformatics}, vol.~25, no.~10, 2009, pp.~1231-1235.  \url{https://doi.org/10.1093/bioinformatics/btp152}
