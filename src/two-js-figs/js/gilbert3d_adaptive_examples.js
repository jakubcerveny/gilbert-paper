...
//
function mkg3curve(xy, whd, s, adapt_method) {
  ...
  for (let idx=0; idx<N; idx++) {
    let _p3 = Gilbert3DAdapt_d2xyz(idx, whd[0], whd[1], whd[2], adapt_method);
...
function gilbert3d_adaptive_examples() {
  ...
  two.makeText("i)", 25, txt_y, font_style);
  mkg3curve([40,fig_y], [3, 5, 4], 30, 0);

  two.makeText("ii)", 210, txt_y, font_style);
  mkg3curve([230,fig_y], [3, 5, 4], 30, 1);

  two.makeText("iii)", 390, txt_y, font_style);
  mkg3curve([410,fig_y], [3, 5, 4], 30, 2);
