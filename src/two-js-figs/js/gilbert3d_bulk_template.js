...
function _dl() {
  var ele = document.getElementById("gilbert3d_canvas");
...
function gilbert3d_bulk() {
  ...
  for (let whd=0; whd<1; whd++) {
    ...
    let sxy = [ start_xy[0] + 170, start_xy[1] + 230 ];
