...
function gilbert3d_eccentric_alpha() {
  let two = g_fig_ctx.two;
  ...
  mathjax2twojs("abs_gamma", cxy[0]-(2.155*scale), cxy[1]+18, latex_name_scale);
  rbracket( [cxy[0] - (1.2*scale), cxy[1]-1], _sl/3, _sl, -Math.PI/2 - theta*0.5);

  //mathjax2twojs("abs_beta", cxy[0]-(2.65*scale), cxy[1]-72, latex_name_scale);
  mathjax2twojs("abs_beta", cxy[0]-(2.95*scale), cxy[1]-69, latex_name_scale);
  rbracket( [cxy[0] - (1.95*scale), cxy[1]-75], _sl/3, _sl, -Math.PI);


  //mathjax2twojs("S0", 20, two.height-20, latex_name_scale);
