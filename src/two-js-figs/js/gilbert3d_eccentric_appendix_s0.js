...
function gilbert3d_eccentric_appendix_s0() {
  let two = g_fig_ctx.two;
  ...
  mathjax2twojs("sigma_s", cxy[0]+(2.35*scale), cxy[1]+10, latex_name_scale);
  rbracket( [cxy[0] + (2.35*scale), cxy[1]-5], _sl/3, 5*_sm, - theta*0.87);

  mathjax2twojs("s", cxy[0]-(1.55*scale), cxy[1]+10, latex_name_scale);
