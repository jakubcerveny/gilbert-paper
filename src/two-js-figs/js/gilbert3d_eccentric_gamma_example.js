...
function mkg3curve(xy, whd, s, idx_pal) {
  ...
  let idx0 = Math.floor(N/4);
  let idx1 = Math.floor(3*N/4);
  ...
  for (let idx=0; idx<N; idx++) {
    ...
    let __p3 = gilbert._d2xyz(idx, whd[0], whd[1], whd[2]);
...
function gilbert3d_gamma_example() {
