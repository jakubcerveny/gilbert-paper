...
function gilbert3d_eccentric_beta_simple() {
  let two = g_fig_ctx.two;
  ...
  mathjax2twojs("one_half", cxy[0]+(1.1*scale), cxy[1]-(scale*4.5), latex_name_scale);
  //rbracket( [ cxy[0] + (1.15*scale), cxy[1]-155], _sl/2.65, 0.95*_sl,   theta*0.62);
  rbracket( [ cxy[0] + (0.95*scale), cxy[1]-(scale*4.45)], _sl/2.65, 0.7*_sl,   theta*0.62);

  mathjax2twojs("one_half", cxy[0]+(2.05*scale), cxy[1]-(scale*3.7), latex_name_scale);
  //rbracket( [ cxy[0] + (2.20*scale), cxy[1]-123], _sl/3, _sm, theta*0.62);
  rbracket( [ cxy[0] + (1.9*scale), cxy[1]-(scale*3.6)], _sl/3, _sl*.7, theta*0.62);


  // bottom s
  mathjax2twojs("abs_gamma", cxy[0]-(3.4*scale), cxy[1]-(2.6*scale), latex_name_scale);
  rbracket( [cxy[0] - (2.6*scale), cxy[1]-(2.8*scale)], _sl/3, _sl, Math.PI);



  mathjax2twojs("beta_gt_gamma", cxy[0]-(4.75*scale), cxy[1]+10, latex_name_scale);
  rbracket( [cxy[0] - (1.50*scale), cxy[1]-15], _sl/3, _sl*1.6, Math.PI + theta*0.62);



  rbracket( [cxy[0] + (0.8*scale), cxy[1]+(0.3*scale)], _sl/3, _sm, - theta*0.86);
  rbracket( [cxy[0] + (1.8*scale), cxy[1]-(0.1*scale)], _sl/3, _sm, - theta*0.86);

  mathjax2twojs("one_half", cxy[0]+(0.8*scale), cxy[1]+35, latex_name_scale);
  mathjax2twojs("one_half", cxy[0]+(1.8*scale), cxy[1]+20, latex_name_scale);
