...
An exploded view of a $J$-split, the $J_0$ split, is shown in Figure \ref{fig:gilbert3DJSplit}.
...
ensuring that the infeasiblie Hamiltonian path region will eventually be resolved at a single point.
