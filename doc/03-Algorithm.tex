...
Since $A$ and $C$ are chosen to have width-like local axis even, no new notches are introduced and notch
that is forced is effectively ``pushed'' into the $C$ block.
