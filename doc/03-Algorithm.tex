...
\begin{figure}[h]
  ...
  \caption{ Two examples of corner cases and pathological conditions for the Gilbert curve.
            (i) An $11 \times 2$ Gilbert curve where the $\alpha$ side length is 11, precluding
            a notch free path but for the $((2k+1) \times 2)$ case, the notch shows up as a hook
            at the end. (ii) A $2 \times 7$ Gilbert that reduces to a snake curve for the $(2 \times k)$ case. }
