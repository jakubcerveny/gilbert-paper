...
For a path starting at $(0,0,0)$ and ending at $|\alpha| \in \mathbb{N}$ away in one of the axis-aligned dimensions,
...
The $U$-split breaks the region into three sub-blocks, labeled $A$, $B$ and $C$, where the
