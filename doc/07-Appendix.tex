...
\begin{figure}[h]
  ...
  \caption{ When the length width like dimension ($|\alpha|$) gets larger than a threshold of the height-like
...
as the ratio of the defects before and after the split is $(1/2)$.
